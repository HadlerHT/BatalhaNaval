...
void  aux_printMatchBorder (unsigned char chr0, unsigned char chr1, unsigned char chr2);                            //(printMatch - aux) Prints the borders
...
void  aux_printMatchBorder (unsigned char chr0, unsigned char chr1, unsigned char chr2) {
	short j;
	printf ("\n    %c", chr0);
	for (j = 0; j < SIZE; j++)
...
void  printLogo (int typeLogo) {
  ...
  const char spaces[5][7] = {{55, 47, 39, 31, 23, 15, 7},  //BATALHA
